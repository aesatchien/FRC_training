...
settings_dict = {
    ...
    'benchmill':{'DRILL_DEPTH':-0.2, 'RETRACT_HEIGHT':0.5, 'ENGAGE_HEIGHT':0.1,
                'LINEAR_FEED':30, 'DRILL_FEED':3, 'RETRACT_FEED':20, 'TOOL':4},
}
...
def generate_gcode(point_list, machine='shapeoko', overrides=None, save_file=False, file_description='test'):
